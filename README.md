...
| alpha_09 | −0.0262 | −0.0805 | −0.0292 | −0.1048 |

IC 最弱 bottom 3（接近零，无明显预测能力）：

| 因子 | IC Mean | IC IR | RankIC Mean | RankIC IR |
|------|---------|-------|-------------|-----------|
| alpha_10 | −0.0004 | −0.0015 | +0.0018 | +0.0058 |
| alpha_15 | +0.0005 | +0.0013 | +0.0007 | +0.0020 |
| alpha_00 | +0.0023 | +0.0092 | +0.0030 | +0.0098 |
